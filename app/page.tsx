...
import { regionToLocale, t } from "@/lib/i18n";
      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 pt-2">
          ...
          >
            ...
            <span>
              <span className="block text-[10px] leading-none opacity-80">{tr.home.appStoreSoon}</span>
            </span>
          </button>
          ...
          >
            ...
            <span>
              <span className="block text-[10px] leading-none opacity-80">{tr.home.playStoreSoon}</span>
            </span>
          </button>
        </div>
      </div>
